        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    System.out.print("Ingin memesan meja dengan no : ");
                    int noMejaPesanan = scanner.nextInt();
                    System.out.print("Nama pelanggan : " ); 
                    String namaPelanggan = scanner.next();
                    Pelanggan pelanggan = new Pelanggan(namaPelanggan);

                    if (daftarMeja[noMejaPesanan-1].isKosong()){
                        daftarMeja[noMejaPesanan-1].setPelanggan(pelanggan);
                    }else {
                        System.out.println("Mohon maaf, meja sudah terisi. Silahkan pilih no meja yang lain.");
                    }
                break;
                ...
                if (!meja) {
                    ...
                    while (!stopLoop) {
                        ...
                        jumlahpesanan++;
                        if (jumlahpesanan==11) {
                            System.out.println("Maksimal jumlah pesanan adalah 10.");
                            break;
                        }
                ...
                case 4:
                    ...
                    System.out.print("Masukkan nomor meja pelanggan yang ingin dihapus : ");
                    int noHapusPelanggan = scanner.nextInt();
                    hapusPelanggan(noHapusPelanggan);
                    break;
                case 5:
                    ...
                    System.out.println("Masukkan nomor meja yang akan dihitung total harga pesanan");
                    int noHitungTotal = scanner.nextInt(); 

                        Menu[] menu = daftarMeja[noHitungTotal-1].getMenu();
                        if (menu != null) {
                           
                            System.out.println("Harga pesanan di meja " + noHitungTotal + " adalah Rp" + hitungHargaPesanan(noHitungTotal));
                        } else {
                            System.out.println("Meja " + noHitungTotal + " tidak memiliki pesanan.");
                        }
                ...
                case 6:
                    ...
                    // tampilkan pesan untuk memasukkan nomor meja 
                    System.out.print("Masukkan nomor meja yang ingin ditampilkan pesanannya : "); 
                    int noTampilkan = scanner.nextInt();
                    
                    Menu[] menu2 = daftarMeja[noTampilkan-1].getMenu();
                    if (menu2 != null) {
                       tampilkanPesanan(noTampilkan);
                    } else {
                        System.out.println("Meja " + noTampilkan + " tidak memiliki pesanan.");
                    }
